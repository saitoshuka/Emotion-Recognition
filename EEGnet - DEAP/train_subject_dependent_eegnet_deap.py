...
def main():
    ...
    for f_name in tqdm(files, desc="Subjects"):
        ...
        print(f"{f_name}: V-Acc {v_res['mean_acc']:.4f} V-F1 {v_res['mean_f1']:.4f} | A-Acc {a_res['mean_acc']:.4f} A-F1 {a_res['mean_f1']:.4f}")
    ...
    out_dir = "deap_eegnet_subject_dependent"
    ...
    print("\n=== EEGNet Subject-dependent Summary ===")
    print(f"Valence: Acc {result['valence']['mean_acc']:.4f}+-{result['valence']['std_acc']:.4f} | F1 {result['valence']['mean_f1']:.4f}+-{result['valence']['std_f1']:.4f}")
    print(f"Arousal: Acc {result['arousal']['mean_acc']:.4f}+-{result['arousal']['std_acc']:.4f} | F1 {result['arousal']['mean_f1']:.4f}+-{result['arousal']['std_f1']:.4f}")
